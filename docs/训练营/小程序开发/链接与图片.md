...
<pre class="lang:css decode:true">#wxmlinfo{
...
<pre class="lang:css decode:true">.imglist .img{
  border-radius: 8px;
...
<pre class="lang:css decode:true">.imglist .circle{
  width: 200px;
  height: 200px;
  border-radius: 100%;
}</pre>
...
<pre class="lang:js decode:true ">&lt;view class="event-list"&gt;
...
&lt;/view&gt;</pre>
在home.wxss里输入以下样式：
<pre class="lang:css decode:true">.event-list{
